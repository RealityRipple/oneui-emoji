...
Acquiring the Samsung OneUI emoji font can be difficult - the current copy in use by this repository is from https://gitgud.io/Van-Firmware-Dumps/samsung/a37x - which is OneUI 8.5 from March of 2026.  
